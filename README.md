...
Credit goes to [@Schwenger](https://github.com/Schwenger) for creating [the original version](https://github.com/Schwenger/CSKey) and [@schaefer-dev](https://github.com/schaefer-dev) for adding nice icons to the layout in [his fork](https://github.com/schaefer-dev/CSKey)!
